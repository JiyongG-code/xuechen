...
public class OrderController {
    ...
    public void requestpay(String payNo, HttpServletResponse httpResponse) throws IOException, AlipayApiException {
        ...
        AlipayTradeWapPayRequest alipayRequest = new AlipayTradeWapPayRequest();//创建API对对应的request
        //        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        alipayRequest.setNotifyUrl("http://funeeu.natappfree.cc/orders/paynotify");//在公共参数中设置回跳和通知地址
//        alipayRequest.setNotifyUrl("http://7ig2hh.natappfree.cc/xuecheng/orders/paynotify");//在公共参数中设置回跳和通知地址
