...
public class OrderServiceImpl implements OrderService {
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo){
        ...
        DefaultAlipayClient defaultAlipayClient = new DefaultAlipayClient(AlipayConfig.URL, APP_ID, APP_PRIVATE_KEY, AlipayConfig.FORMAT, AlipayConfig.CHARSET, ALIPAY_PUBLIC_KEY, AlipayConfig.SIGNTYPE);
        ...
        String body =null;
        try {
            AlipayTradeQueryResponse execute = defaultAlipayClient.execute(alipayTradeQueryRequest);//通过alipayClient调用API，获取对应的responsel类
